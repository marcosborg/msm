...
<div class="card">
    <div class="card-header">
        {{ trans('global.create') }} {{ trans('cruds.commonInformation.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.common-informations.store") }}" enctype="multipart/form-data">
            @csrf
            <div class="form-group">
                <label for="footer_info">{{ trans('cruds.commonInformation.fields.footer_info') }}</label>
                <textarea class="form-control {{ $errors->has('footer_info') ? 'is-invalid' : '' }}" name="footer_info" id="footer_info">{{ old('footer_info') }}</textarea>
